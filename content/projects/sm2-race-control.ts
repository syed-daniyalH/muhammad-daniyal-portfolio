...
export const sm2RaceControl = {
  ...
  summary:
    "A full-stack motorsport operations platform that organizes race sessions, telemetry notes, OpenAI voice transcription, and Make.com OCR intake inside a unified FastAPI and PostgreSQL backend.",
  metaDescription:
